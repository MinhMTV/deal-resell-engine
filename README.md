...
- Profit-Report unterstützt `--min-profit`, `--min-roi`, `--sort-by score|profit` und `--top N`
...
python -m app.main profit-report --min-score 55 --days 7 --provider auto --min-profit 0 --min-roi 5 --sort-by profit --top 5
```
