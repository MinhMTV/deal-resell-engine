...
- Profit-Report unterstützt `--min-profit` für fokussierte Kandidatenliste und `--sort-by score|profit`
...
python -m app.main profit-report --min-score 55 --days 7 --provider auto --min-profit 0 --sort-by profit
```
