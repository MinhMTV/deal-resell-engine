...
- Profit-Report unterstützt `--min-profit` für fokussierte Kandidatenliste, `--sort-by score|profit` und `--top N`
...
python -m app.main profit-report --min-score 55 --days 7 --provider auto --min-profit 0 --sort-by profit --top 5
```
